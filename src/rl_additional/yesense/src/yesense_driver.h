...
#include "yesense_imu/YesenseImuInertialData.h"
#include "yesense_imu/YesenseImuNavData.h"
#include "yesense_imu/YesenseImuSensorData.h"
...
private:
    ...
    ros::Publisher imu_pub_,                 /*ROS定义的imu topic*/
                    imu_marker_pub_;         /*ROS定义的,用于 rviz 可视化*/            
    ros::Publisher imu_inertial_data_pub_,  /*自定义的imu topic*/
                    imu_gps_data_pub_,      /*自定义的GNSS NMEA topic*/
                    imu_gnss_data_pub_,     /*自定义的GNSS All data topic*/
                    imu_nav_pub_,           /*自定义的GNSS basic data topic*/
                    imu_status_pub_,        /*自定义的Navigation fusion status topic*/
                    imu_sensor_data_pub_;   /*自定义的All yesense output data topic*/
    ...
    std::shared_ptr<std::deque<char>>  data_buffer_ptr_;
