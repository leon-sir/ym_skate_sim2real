...
YKSMotorData motorDate_recv[14];
...
const float Kt[6] = {2.1, 2.1, 2.35, 2.5, 1.4, 1.4};
...
int EtherCAT_Init(char *ifname)
{
  int i;
  int rc;
  // std::thread imuThread(processIMUData);
...
//     if (receive_and_process_data(imuData_recv) == -1)
//     {
//       printf("Failed to open or process serial data.\n");
//     }
// }
  ...
  for (int slave = 0; slave < ec_slavecount; ++slave)
  {
    ...
    if (slave == 0)
    {
      for (int motor_index = 0; motor_index < 6; ++motor_index)
      {
        ...
        {
        case 0:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[0];
          break;
        case 1:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[1];
          break;
        case 2:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[2];
          break;
        case 3:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[3];
          break;
        case 4:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[4];
          break;
        case 5:
          motorDate_recv[motor_index].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[5];
          break;
        default:
          break;
        }
        // printf("left %d motor position is %f.\n",motor_index,rv_motor_msg[motor_index].angle_actual_rad);
      }
      for (int setzero = 0; setzero < 6; setzero++)
      {
        rv_motor_msg[setzero].angle_actual_rad = 0.0;
        rv_motor_msg[setzero].speed_actual_rad = 0.0;
    ...
    else if (slave == 1)
    {
      for (int motor_index = 0; motor_index < 6; ++motor_index)
      {
        ...
        {
        case 0:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[0];
          break;
        case 1:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[1];
          break;
        case 2:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[2];
          break;
        case 3:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[3];
          break;
        case 4:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[4];
          break;
        case 5:
          motorDate_recv[motor_index + 6].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[5];
          break;
        default:
          break;
        }
    ...
    else if (slave == 2)
    {
      ...
      {
        motorDate_recv[motor_index + 12].pos_ = rv_motor_msg[motor_index].angle_actual_rad;
        motorDate_recv[motor_index + 12].vel_ = rv_motor_msg[motor_index].speed_actual_rad;
        // std::cout << " pos_ " << motorDate_recv[motor_index + 12].pos_ << std::endl;
        switch (motor_index)
        {
        case 0:
          motorDate_recv[motor_index + 12].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[0];
          break;
        case 1:
          motorDate_recv[motor_index + 12].tau_ = rv_motor_msg[motor_index].current_actual_float * Kt[0];
          break;
...
void EtherCAT_Send_Command(YKSMotorData *mot_data)
{
  ...
  for (int index = 0; index < 14; index++)
  {
    ...
    {
      slave = 2;
      // send_motor_ctrl_cmd(&Tx_Message[2], 1, 1, 250, 5, 0, 0, 0);
      send_motor_ctrl_cmd(&Tx_Message[slave], 1, 1, mot_data[12].kp_, mot_data[12].kd_, mot_data[12].pos_des_,
                          mot_data[12].vel_des_, mot_data[12].ff_);
    }
    else if (index == 13)
    {
      slave = 2;
      // send_motor_ctrl_cmd(&Tx_Message[2], 2, 2,    250,              5,       0, 0, 0);
      send_motor_ctrl_cmd(&Tx_Message[slave], 2, 2, mot_data[13].kp_, mot_data[13].kd_, mot_data[13].pos_des_,
                          mot_data[13].vel_des_, mot_data[13].ff_);
    }
